...
APPROXIMATE_AVERAGE_SUNSET_LENGTH_SECONDS = int(os.getenv("APPROXIMATE_AVERAGE_SUNSET_LENGTH_SECONDS") or 1800)
...
if ENABLE_SUN_BASED_BRIGHTNESS == 1:
    ...
    if os.getenv("APPROXIMATE_AVERAGE_SUNSET_LENGTH_SECONDS") is None:
        raise ValueError(
